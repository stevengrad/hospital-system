...
.logo-icon.logo-fallback img {
    display: none;
}

.logo-icon.logo-fallback i {
    display: block;
}
...
<div class="page-shell">
    ...
    <header class="topbar glass">
        <div class="brand">
           <div class="logo-icon" id="contactBrandLogo">
                 <img src="assets/Cairo_hospitals1.png?v=2" alt="Cairo Hospitals" onerror="document.getElementById('contactBrandLogo').classList.add('logo-fallback');">
